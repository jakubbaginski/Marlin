...
#define STRING_CONFIG_H_AUTHOR "(Kuba, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "(BTT SKR MINI E3 v1.2 + TTF35 E3 v3 + BLTOUCH, Ender-3 Pro)"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, -1 }
